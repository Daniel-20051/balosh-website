    ...
    <section ref={ref} className="relative py-8 md:py-12 overflow-hidden">
      <div className="max-w-4xl mx-auto px-4">
        <SectionHeader
          ...
          titleHighlight="Managing Director"
          description="A note of appreciation and our vision as we approach two decades of impact."
          className={`${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
          } transition-all duration-700 mb-6 md:mb-8`}
        />
        <div
          className={`${
            isVisible ? "opacity-100 scale-100" : "opacity-0 scale-95"
          } transition-all duration-700 w-10 h-10 rounded-xl bg-gray-900 text-white flex items-center justify-center shadow-lg mb-2`}
        >
          <svg
            width="24"
            height="24"
            ...
            aria-hidden
          >
            <g clipPath="url(#clip0_4418_7894)">
              <path
