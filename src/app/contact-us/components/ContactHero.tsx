...
const PhoneIcon = () => (
  ...
  >
    <g clipPath="url(#clip0_4418_8833)">
      <path
...
export default function ContactHero() {
  return (
    <section className="relative h-[70vh] overflow-hidden bg-gray-50 py-20 flex items-center justify-center">
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div className="h-[560px] w-[560px] rounded-full bg-orange-400/10 blur-3xl" />
      </div>

      <div className="relative mx-auto max-w-5xl px-4 text-center">
        <Badge text="Get In Touch" icon={<PhoneIcon />} />

        <h1 className="mt-15 text-3xl font-semibold leading-tight text-gray-900 md:text-5xl">
          Let&apos;s Secure Your{" "}
        ...
        <p className="mx-auto mt-4 max-w-2xl text-gray-600">
          Have a project in mind or need support? Our team is just a message
          away.
        </p>
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-md border-1 border-gray-200 bg-white px-4 py-2 text-sm text-gray-900 font-bold transition hover:border-orange-300 "
          >
