...
function ImpactCard({ number, label, suffix = "+" }: ImpactCardProps) {
  ...
  return (
    <div
      ref={cardRef}
      className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 text-center border border-white/30 hover:bg-white/30 transition-all duration-300 group"
    >
...
export default function ImpactSection() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-[#dd7723] to-[#e59e3e] py-10 overflow-hidden">
